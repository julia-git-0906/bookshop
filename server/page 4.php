...
// Get the result...
if ($result = $mysqli->query('SELECT * FROM knigi ORDER BY ' .  $column . ' ' . $sort_order)) {
  ...
  <input type="radio" name="value" value="роман"> роман<br>
  <!--<input type="radio" name="value" value="детектив"> детектив<br>
  <input type="radio" name="value" value="учебная литература"> учебная литература<br><br>-->
  <br>
